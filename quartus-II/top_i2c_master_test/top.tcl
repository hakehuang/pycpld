...
if {$make_assignments} {
	...
	set_global_assignment -name VERILOG_FILE I2C_MASTER_reduced.v
set_global_assignment -name VERILOG_FILE I2C_wr_reduced.v
set_global_assignment -name VERILOG_FILE test_i2c_master.v
set_global_assignment -name VERILOG_FILE I2C_MASTER_reduced.v
set_global_assignment -name VERILOG_FILE I2C_wr_reduced.v
set_global_assignment -name VERILOG_FILE test_i2c_master.v
...
set_global_assignment -name VERILOG_FILE uart_tx.v
	...
	set_location_assignment PIN_82 -to BusA[82]
set_location_assignment PIN_84 -to BusA[84]
set_location_assignment PIN_82 -to BusA[82]
