...
set_global_assignment -name VERILOG_FILE uart_rx7to7.v
set_global_assignment -name VERILOG_FILE uart_top7to7.v
set_global_assignment -name VERILOG_FILE uart_tx7to7.v
set_global_assignment -name VERILOG_FILE data_deal.v
...
set_global_assignment -name VERILOG_FILE uart_tx.v
	...
	set_location_assignment PIN_50 -to BusC[50]
set_location_assignment PIN_62 -to BusD[62]
set_location_assignment PIN_61 -to BusD[61]
set_location_assignment PIN_16 -to BusB[16]
